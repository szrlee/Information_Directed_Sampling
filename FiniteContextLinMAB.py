...
class FiniteContextPaperLinModel(ArmGaussianLinear):
    def __init__(self, u, n_context, n_features, n_actions, eta=1, sigma=10):
        ...
        self.eta = eta
        self.all_features = self.prior_random.uniform(-u, u, (n_context, n_actions, n_features))
...
class FiniteContextFGTSLinModel(ArmGaussianLinear):
    def __init__(self, n_context, n_features=100, n_actions=2, eta=sqrt(0.5)):
        """
        Initialization of the arms, features and theta in
        ...
        if n_actions > 2:
            self.all_features[:, 2:] = self.prior_random.uniform(-1, 1, (n_actions-2, n_features)) 
