...
param = {
    ...
    "VIDS_action_hyper":          {"M": 10000, 'optim_action':True, **hyper_params, 'fg_lambda':0.0},
    "VIDS_action_hyper:Reset":    {"M": 10000, 'optim_action':True, **hyper_params, 'fg_lambda':0.0, 'reset':True, 'update_num': args.repeat_num},
    "VIDS_action_hyper:FG":       {"M": 10000, 'optim_action':True, **hyper_params, 'fg_decay': False},
    "VIDS_action_hyper:FG Decay": {"M": 10000, 'optim_action':True, **hyper_params},
    "VIDS_action:theta":          {"M": 10000, 'optim_action':False},
    "VIDS_action_hyper:theta":    {"M": 10000, 'optim_action':False, **hyper_params, 'fg_lambda':0.0},

    "VIDS_policy":                {"M": 10000, 'optim_action':True},
    "VIDS_policy_hyper":          {"M": 10000, 'optim_action':True, **hyper_params, 'fg_lambda':0.0},
    "VIDS_policy_hyper:Reset":    {"M": 10000, 'optim_action':True, **hyper_params, 'fg_lambda':0.0, 'reset':True, 'update_num': args.repeat_num},
    "VIDS_policy_hyper:FG":       {"M": 10000, 'optim_action':True, **hyper_params, 'fg_decay': False},
    "VIDS_policy_hyper:FG Decay": {"M": 10000, 'optim_action':True, **hyper_params},
    "VIDS_policy:theta":          {"M": 10000, 'optim_action':False},
    "VIDS_policy_hyper:theta":    {"M": 10000, 'optim_action':False, **hyper_params, 'fg_lambda':0.0},
}
